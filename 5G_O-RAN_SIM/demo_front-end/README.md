...
The frontend now works best with the telco bridge layer running from:

- `9.LABS_pure_os_stack/source_code/4_redhat/telco_ai_factory_prototype/bridge_server.py`

The bridge aggregates BF3 data sources and exposes the UI-facing endpoints below.
...
- **Core Network Status**: `http://localhost:8088/api/nf/status`
- **Simulation Control**: `http://localhost:8088/api/simulation/*`
- **Metrics & Analytics**: `http://localhost:8088/api/metrics/*`
- **Logs**: `http://localhost:8088/api/logs`
- **N6 Firewall**: `http://localhost:8088/api/firewall/status`
...
NEXT_PUBLIC_CORE_API_URL=http://localhost:8088
NEXT_PUBLIC_FIREWALL_API_URL=http://localhost:8088
