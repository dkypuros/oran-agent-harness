...
\node[l4] (l4) at (0, 3.6) {\textbf{Layer 4: End-to-end fixture replay}\\ \scriptsize verify gate check 10 (walker\_e2e), 5 scenarios, 8 material fields};
...
\end{tikzpicture}
\caption{Four-layer claim anchoring system. Each layer is mechanically enforced by a specific check of the verify gate. Layer 1 turns documentation into a contract; Layer 4 turns architectural claims into mechanically falsifiable assertions against committed expected outputs.}
\label{fig:fourlayer}
\end{figure}
